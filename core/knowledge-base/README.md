...
Отдельно важно: эта возможность выведена и в UI через вкладку `Library`, где можно видеть сохранённые материалы и работать с ними как с личной исследовательской библиотекой.
